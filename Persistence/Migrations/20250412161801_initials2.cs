        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreateEdBy = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentAttributeId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreateEdBy = table.Column<Guid>(type: "uuid", nullable: false),
                    UpdatedBy = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductAttributes_ProductAttributes_ParentAttributeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    AllowEmailNotifications = table.Column<bool>(type: "boolean", nullable: false),
                    AllowSmsNotifications = table.Column<bool>(type: "boolean", nullable: false),
                    AllowPushNotifications = table.Column<bool>(type: "boolean", nullable: false),
                    AllowOrderStatusUpdates = table.Column<bool>(type: "boolean", nullable: false),
                    AllowPromotionalEmails = table.Column<bool>(type: "boolean", nullable: false),
                    AllowWishlistAlerts = table.Column<bool>(type: "boolean", nullable: false),
                    AllowReviewAlerts = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    WebsiteContentId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_MenuItems_WebsiteContents_WebsiteContentId",
                        column: x => x.WebsiteContentId,
                        principalTable: "WebsiteContents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<Guid>(type: "uuid", nullable: false),
                    FilterId = table.Column<Guid>(type: "uuid", nullable: false),
                    FilterValueId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreateEdBy = table.Column<Guid>(type: "uuid", nullable: false),
                    UpdatedBy = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductFilters_FilterValues_FilterValueId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductAttributeMappings_ProductAttributeValues_ProductAttr~",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductVariantAttributes_ProductAttributeValues_ProductAttr~",
                        column: x => x.ProductAttributeValueId,
                        principalTable: "ProductAttributeValues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductVariantAttributes_ProductAttributes_ProductAttribute~",
                        column: x => x.ProductAttributeId,
                        principalTable: "ProductAttributes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuItems_WebsiteContentId",
                table: "MenuItems",
                column: "WebsiteContentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductAttributes_ParentAttributeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductFilters_FilterValueId",
                table: "ProductFilters",
